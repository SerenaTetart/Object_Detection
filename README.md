...
For the inference you only need Tensorflow, **inference.py** shared in this repository, the directory **saved_model** and the file: **label_map.pbtxt**. *(you can automatically download both by running the code in colab)*
