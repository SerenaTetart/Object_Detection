...
For the inference you only need Tensorflow, the directory *saved_model* (*you can automatically download it by running the code in colab*) and the file: *label_map.pbtxt*.
